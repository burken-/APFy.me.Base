...
/*            set
    ...
    public class SgmlReader : XmlReader
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to skip default namespace in document.
        /// </summary>
        /// <value><c>true</c> if default namespace should be ignored; otherwise, <c>false</c>.</value>
        public bool SkipDefaultNamespace {
            get { return m_skipDefaultNamespace; }
            set { m_skipDefaultNamespace = value; }
        }
        ...
        public override string Name
        {
            get
            {
                ...
                string atom = m_nametable.Get(result);
                if (atom == null)
                {
                    atom = m_nametable.Add(result);
                }
        ...
        private bool ParseStartTag(char ch)
        {
            ...
            while (ch != Entity.EOF && ch != '>')
            {
                ...
                if (SkipDefaultNamespace && aname.Equals("xmlns", StringComparison.OrdinalIgnoreCase))
                    continue;
